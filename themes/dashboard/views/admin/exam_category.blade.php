    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ url('/admin/add_new_category')}}" class="database_operation-file" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-sm-12">
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <input type="file" required="required" name="photo" id="photo" accept="image/*" class="form-control-file">
                </div>
              </div>
              <div class="col-sm-12">
                <div class="form-group">
